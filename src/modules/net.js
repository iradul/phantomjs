/***** < ivan *****/
function create() {
    var _net = phantom.createNet();

    Object.defineProperty(_net, 'handleRedirections', {
        value: false,
        writable: true,
        enumerable: true,
        configurable: false
    ...
    Object.defineProperty(_net, 'maxRedirections', {
        value: 10,
        writable: true,
        enumerable: true,
        configurable: false
    ...
    _net.upload = function (url, file, mime, headers, method) {
        var postObj = {
            headers: headers || '',
            upload: { 
                file: file,
    ...
    _net.download = function (url, file, headers, method) {
        var postObj = {
            headers: headers || '',
            download: { 
                file: file
    ...
    _net.fetch = function (url, method, data, headers, encode, fileEncoding) {
